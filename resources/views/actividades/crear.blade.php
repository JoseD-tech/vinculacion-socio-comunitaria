                ...
                <tbody>
                    @foreach ($actividades as $actividad)
                        <tr>
                            ...
                            <x-adminlte-modal id="editar-actividad-{{ $actividad->id }}" title="Editar Programa"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <x-adminlte-input-date name="fechaAprobacion" label="Fecha De Aprobacion" igroup-size="md"
                                                :config="$configdate" placeholder="Fecha de aprobacion">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <x-adminlte-input-date name="fechaFinalizacon" label="Fecha De Finalizacion" igroup-size="md"
                                                :config="$configdate" placeholder="Fecha de finalizacion">
                                                <x-slot name="appendSlot">
                                                    <div class="input-group-text bg-dark">
                                                        <i class="fas fa-calendar-day"></i>
                                                    </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="custom-select" id="responsableAdministrativo" name="responsableAdministrativo[]" required>
