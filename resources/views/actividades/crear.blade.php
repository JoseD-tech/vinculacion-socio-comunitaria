        ...
        <div class="mt-2 table-responsive text-nowrap">
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="tipoActividad">Tipo de
                                                        Actividad</label>
                                                    <select class="custom-select" id="tipoActividad" name="tipoActividad[]"
                                                        required>
                                                        <option selected disabled>Selecciona Tipo de Actividad</option>
                                                        @foreach ($tiposActividades as $tipo)
                                                            <option value="{{ $tipo->id }}">{{ $tipo->TipoActividad }}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="programaActividad">Programa
                                                        Academico</label>
                                                    <select class="custom-select" id="programaActividad"
                                                        name="programaActividad[]" required>
                                                        <option selected disabled>Selecciona Un Programa Academico</option>
                                                        @foreach ($programas as $tipo)
                                                            <option value="{{ $tipo->id }}">
                                                                {{ $tipo->programa_academico }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label style="display: block;" for="estadoActividad">Estado
                                                        Actividad</label>
                                                    <select class="custom-select" id="estadoActividad"
                                                        name="estadoActividad[]" required>
                                                        <option selected disabled value="">Selecciona Un Estado
                                                        </option>
                                                        @foreach ($status as $tipo)
                                                            <option value="{{ $tipo->id }}">
                                                                {{ $tipo->status_actividad }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-3 mb-3">
                                                    <label style="display: block;" for="codigoActividad">Codigo
                                                        Actividad</label>
                                                    <input type="number" class="form-control" style="max-width: 100%"
                                                        id="codigoActividad" name="codigoActividad" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="tituloActividad">Titulo
                                                        Actividad</label>
                                                    <input type="text" class="form-control" style="max-width: 100%"
                                                        id="tituloActividad" name="tituloActividad" required>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    <label style="display: block;" for="lineaActividad">Linea De
                                                        Investigacion</label>
                                                    <select class="custom-select" id="lineaActividad"
                                                        name="lineaActividad[]" required>
                                                        <option selected disabled value="">Selecciona Una Linea De
                                                            Investigacion</option>
                                                        @foreach ($linea as $tipo)
                                                            <option value="{{ $tipo->id }}">
                                                                {{ $tipo->linea_investigacion }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <x-adminlte-input-date name="fechaAprobacion"
                                                        label="Fecha De Aprobacion" igroup-size="md" :config="$configdate"
                                                        placeholder="Fecha de aprobacion" required>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <x-adminlte-input-date name="fechaFinalizacon"
                                                        label="Fecha De Finalizacion" igroup-size="md" :config="$configdate"
                                                        placeholder="Fecha de finalizacion" required>
                                                        <x-slot name="appendSlot">
                                                            <div class="input-group-text bg-dark">
                                                                <i class="fas fa-calendar-day"></i>
                                                            </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <x-adminlte-input-date name="fechaCierre" label="Fecha De Cierre"
                                                        igroup-size="md" :config="$configdate" placeholder="Fecha de Cierre"
                                                        required>
                                                        <x-slot name="appendSlot">
                                                            <div class="input-group-text bg-dark">
                                                                <i class="fas fa-calendar-day"></i>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="personasAtendidas">Personas
                                                        Atendidas</label>
                                                    <input type="number" class="form-control" style="max-width: 100%"
                                                        id="personasAtendidas" name="personasAtendidas" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="personasInscritas">Personas
                                                        Inscritas</label>
                                                    <input type="number" class="form-control" style="max-width: 100%"
                                                        id="personasInscritas" name="personasInscritas" required>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;"
                                                        for="responsableAdministrativo">Responsable Administrativo</label>
                                                    <select class="custom-select" id="responsableAdministrativo"
                                                        name="responsableAdministrativo[]" required>
                                                        <option selected disabled>Selecciona Una Responsable Administrativo
                                                        </option>
                                                        @foreach ($administrativo as $tipo)
                                                            <option value="{{ $tipo->id }}">
                                                                {{ $tipo->responsable_administrativo }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label style="display: block;" for="responsableAcademico">Responsable
                                                        Academico</label>
                                                    <select class="custom-select" id="responsableAcademico"
                                                        name="responsableAcademico[]" required>
                                                        <option selected disabled value="">Selecciona Una Responsable
                                                            Academico</option>
                                                        @foreach ($responsable as $tipo)
                                                            <option value="{{ $tipo->id }}">{{ $tipo->responsable }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
            ...
            @else
                <div class="mt-4 text-center">
                    <h3>No Hay Registros de Actividades Puedes Registrar</h3>
                </div>
